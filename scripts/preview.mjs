...
for(const m of projects){
  ...
  sections+='<section id="p'+m.number+'"><div class="section-head"><h2><span>'+m.number+'</span> '+esc(m.displayName)+'</h2><a href="https://github.com/'+m.repo+'" target="_blank" rel="noreferrer">Repository ↗</a></div><img class="hero" src="'+m.dir+'/hero-light.svg" data-light="'+m.dir+'/hero-light.svg" data-dark="'+m.dir+'/hero-dark.svg" alt="'+esc(m.displayName+' — '+m.tagline.en)+'"><div class="caption"><p>'+esc(m.tagline.zh||m.tagline.en)+'</p><a href="'+m.dir+'/social-preview.png">Social preview · 1280×640 ↗</a></div>'+proof+'</section>';
}
